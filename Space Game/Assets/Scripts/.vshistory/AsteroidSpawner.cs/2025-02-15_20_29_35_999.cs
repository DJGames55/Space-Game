...
public class AsteroidSpawner : MonoBehaviour
{
    ...
    [SerializeField] private int asteroidCount;       // Number of asteroids to spawn
    [SerializeField] private Vector2 scaleRange; // Min and max scale
    [SerializeField] private float fieldRadius;       // Radius of the spawn field
    [SerializeField] private float minSpawnDistance;   // Minimum distance from the center
    [SerializeField] private float centerBias;         // Higher values make more spawn near the center
