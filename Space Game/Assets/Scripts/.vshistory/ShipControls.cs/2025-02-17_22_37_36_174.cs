...
public class ShipControls : MonoBehaviour
{
    ...
    public IEnumerator QTStart(GameObject travelLocation, bool starTravel, Vector3 starLocation)
    {
        _ui.CloseQT();
        _input.SetUI();
    ...
    private IEnumerator StarQT(Vector3 starLocation)
    {
        loadingQT = true;
        ...
        // Cache the initial rotation and the target rotation
        Quaternion initialRotation = playerShip.transform.rotation;
        Quaternion targetRotation = Quaternion.LookRotation(starLocation.transform.position - playerShip.transform.position);
