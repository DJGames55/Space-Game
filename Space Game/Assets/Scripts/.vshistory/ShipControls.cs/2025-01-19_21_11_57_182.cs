...
public class ShipControls : MonoBehaviour
{
    ...
    public IEnumerator QT(GameObject travelLocation)
    {
        ...
        {
            // Calculate the value of t based on time
            float t = Mathf.PingPong(Time.time * moveSpeed, 1);  // t will oscillate between 0 and 1 over time

            // Smoothly interpolate from current position to the target position (travelLocation)
