...
public class ShipControls : MonoBehaviour
{
    ...
    public static SceneField currentSceneStatic;
    ...
    private void Awake()
    {
        ...
        currentScene = currentSceneStatic;
    }
    ...
    public void InitiateQT(GameObject button)
    {
        ...
        Vector3 starLocation = new Vector3(0, 0, 0);

        StartQT(travelLocation, warpName, starTravel, starLocation, starScene);
    }

    public void FindStarLoc(SceneField starScene)
    {
