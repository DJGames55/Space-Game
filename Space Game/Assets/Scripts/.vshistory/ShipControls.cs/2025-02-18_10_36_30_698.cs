...
public class ShipControls : MonoBehaviour
{
    ...
    public void InitiateQT(GameObject button)
    {
        ...
        string starScene = QTVar.starScene;

        StartQT(travelLocation, warpName, starTravel, starLocation, starScene);
    }

    public void StartQT(GameObject travelLocation, string warpName, bool starTravel, Vector3 starLocation, string starScene)
    {
    ...
    public IEnumerator QTStart(GameObject travelLocation, string warpName, bool starTravel, Vector3 starLocation, string starScene)
    {
        _ui.CloseQT();
        _input.SetUI();
    ...
    private IEnumerator StarQT(Vector3 starLocation, string starScene, string warpName)
    {
        loadingQT = true;
