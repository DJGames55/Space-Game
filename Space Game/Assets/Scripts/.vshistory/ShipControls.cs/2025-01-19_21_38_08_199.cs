...
public class ShipControls : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (isQT)
        {
            float speed = 5f; // The speed at which the ship moves
            playerShip.transform.position = Vector3.Lerp(playerShip.transform.position, travelPos.transform.position, speed * Time.deltaTime);
            Debug.Log("ballz");
