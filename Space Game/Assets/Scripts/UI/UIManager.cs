...
public class UIManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        pauseMenus.GetComponent<CanvasGroup>().alpha = 0;
        ...
        pauseMenus.GetComponent<CanvasGroup>().blocksRaycasts = false;
    ...
    public void Pause()
    {
        pauseMenus.GetComponent<CanvasGroup>().blocksRaycasts = true;
        menu.SetActive(true);
        optionsMenu.SetActive(false);
        currentMenu = "pauseMenu";
        StartCoroutine(Fade(pauseMenus, 0, 1, 0.2f));
    }
    ...
    public void Resume()
    {
        switch (currentMenu)
        {
            case "pauseMenu":
                pauseMenus.GetComponent<CanvasGroup>().blocksRaycasts = false;
                StartCoroutine(Fade(pauseMenus, 1, 0, 0.2f));
                break;
            case "QTMenu":
                QTMenuBackground.GetComponent<CanvasGroup>().blocksRaycasts = false; 
