...
public class UIManager : MonoBehaviour
{
    ...
    public float GetStarDistance(SceneField targetStar)
    {
        ...
        {
            Debug.Log(data.fromStar.ToString());
            Debug.Log(data.toStar.ToString());
            Debug.Log(_ship.currentScene.ToString());
            if (data.fromStar.ToString() == _ship.currentScene.ToString())
                Debug.Log("SameScene");
        }
