...
public class UIManager : MonoBehaviour
{
    ...
    private List<StarLocations.DistanceData> savedDistances;
    ...
    private void Awake()
    {
        ...
        if (_starLocData != null)
            savedDistances = _starLocData.savedDistances;
    }
    ...
    public void GetStarDistance(SceneField targetStar)
    {
