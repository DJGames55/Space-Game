...
public class QTButton : MonoBehaviour
{
    ...
    [SerializeField] private WarpPos warpPosLocator;
    ...
    {
        foreach (var warp in Object.FindAnyObjectByType<GameObject>())
        {
            if (warp.transform.GetComponent<WarpPos>.warpPosID == warpPosID)
            {
                Debug.Log("Match");
            }
        }
