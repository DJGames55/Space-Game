...
public class QTControls : MonoBehaviour
{
    ...
    private IEnumerator QT(GameObject travelLocation, string warpName)
    {
        ...
        while (Vector3.Distance(playerShip.transform.position, travelLocation.transform.position) > 2f)
        {
            ...
            if (Vector3.Distance(playerShip.transform.position, travelLocation.transform.position) < (Vector3.Distance(nextQTLoc.transform.position, lastLoc.transform.position) / 2))
            {
