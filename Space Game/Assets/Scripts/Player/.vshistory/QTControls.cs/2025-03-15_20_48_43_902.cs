...
public class QTControls : MonoBehaviour
{
    ...
    public void InitiateQT(GameObject button)
    {
        ...
        Vector3 travelLocation = Vector3.zero;
        ...
        {
            travelLocation = QTVar.warpPos.transform.position;
        }
    ...
    private IEnumerator QT(Vector3 travelLocation, string warpName)
    {
        ...
        while (Vector3.Distance(playerShip.transform.position, travelLocation) > 2f)
        {
            ...
            if (Vector3.Distance(playerShip.transform.position, travelLocation) < Vector3.Distance(nextQTLoc.transform.position, lastLoc.transform.position))
            {
